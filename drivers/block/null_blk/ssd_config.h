...
#define NS_CAPACITY_1 (0)
#define MDTS (6)
#define CELL_MODE (CELL_MODE_SLC)  //CELL_MODE_TLC

#define SSD_PARTITIONS (1)
#define NAND_CHANNELS (4) //8
#define LUNS_PER_NAND_CH (2)  //16
#define FLASH_PAGE_SIZE KB(16) //64
#define PLNS_PER_LUN (1) /* not used*/
#define DIES_PER_ZONE (8) //1
...
#define ZONE_SIZE MB(96) /* kernal only support zone size which is power of 2 */
#else /* If kernel is not modified, use this config for just testing ZNS*/
#define ONESHOT_PAGE_SIZE (FLASH_PAGE_SIZE * 1)// 2
#define ZONE_SIZE MB(32)
#endif
// static_assert((ONESHOT_PAGE_SIZE % FLASH_PAGE_SIZE) == 0);
...
#define NAND_4KB_READ_LATENCY_LSB (44000)
#define NAND_4KB_READ_LATENCY_MSB (44000)
#define NAND_4KB_READ_LATENCY_CSB (44000)
#define NAND_READ_LATENCY_LSB (44000 + 6000)
#define NAND_READ_LATENCY_MSB (44000 + 6000)
#define NAND_READ_LATENCY_CSB (44000 + 6000)
#define NAND_PROG_LATENCY (125000)  //1913640
#define NAND_ERASE_LATENCY (0)

#define FW_4KB_READ_LATENCY (21500) //37540 - 7390 + 2000
#define FW_READ_LATENCY (30490) //37540 - 7390 + 2000
#define FW_WBUF_LATENCY0 (4000)
#define FW_WBUF_LATENCY1 (460)
#define FW_CH_XFER_LATENCY (413)
#define OP_AREA_PERCENT (0)
...
/* Don't modify followings. BLK_SIZE is caculated from ZONE_SIZE and DIES_PER_ZONE */
#define BLKS_PER_PLN 260 /* =for ufs= BLK_SIZE should not be 0 234*/ 
#define BLK_SIZE (ZONE_SIZE / DIES_PER_ZONE) /* =for zufs=*/
// static_assert((ZONE_SIZE % DIES_PER_ZONE) == 0);
...
// #define ONESHOT_PAGE_SIZE (FLASH_PAGE_SIZE * 1)
// #define BLKS_PER_PLN (260) //8192
// #define BLK_SIZE (0) /*BLKS_PER_PLN should not be 0 */
// // static_assert((ONESHOT_PAGE_SIZE % FLASH_PAGE_SIZE) == 0);

// #define MAX_CH_XFER_SIZE KB(16) /* to overlap with pcie transfer */
// #define WRITE_UNIT_SIZE (ONESHOT_PAGE_SIZE)// 512

// #define NAND_CHANNEL_BANDWIDTH (800ull) //MB/s
// #define PCIE_BANDWIDTH (3360ull) //MB/s 3360ull

// #define NAND_4KB_READ_LATENCY_LSB (25485) //ns 35760 - 6000 //25485
// #define NAND_4KB_READ_LATENCY_MSB (25485) //ns 35760 + 6000
// #define NAND_4KB_READ_LATENCY_CSB (25485) //not used
// #define NAND_READ_LATENCY_LSB (25485 + 6000) // 36013 - 6000
// #define NAND_READ_LATENCY_MSB (25485 + 6000) // 36013 + 6000
// #define NAND_READ_LATENCY_CSB (25485 + 6000) //not used
// #define NAND_PROG_LATENCY (125000) // 185000 //1250000
// #define NAND_ERASE_LATENCY (0)

// #define FW_4KB_READ_LATENCY (21500)
// #define FW_READ_LATENCY (30490) //30490
// #define FW_WBUF_LATENCY0 (4000) //4000
// #define FW_WBUF_LATENCY1 (460) //460
// #define FW_CH_XFER_LATENCY (413) //0
// #define OP_AREA_PERCENT (0.07)
...
/* Still only support NR_NAMESPACES_NVMEV <= 2 */
// static_assert(NR_NAMESPACES_NVMEV <= 2);
